...
export function EndpointCard({ path, method, operation,spec }: EndpointCardProps) {
        ...
        <Card>
            ...
            <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    {/* --- 右ペイン: サンプル --- */}
                    <EndpointExample responseCodes={responseCodes} operation={operation} schemas={spec.components?.schemas}/>
                </div>
            </CardContent>
        </Card>
    );
