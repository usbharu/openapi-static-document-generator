		...
		<div className={"space-y-12"}>
			<section id="overview">
				<h1 className="flex items-center gap-4 text-4xl font-bold">
					...
					<Badge className={"text-4xl text-white font-bold"}>{p.version}</Badge>
				</h1>
							...
							<TableRow>
								<TableCell>
									<a href={`#endpint-get-${pathString}`}>
										<Badge
											className={`text-lg text-white font-bold ${getMethodBadgeColor("get")}`}
										>
											GET
										</Badge>
									</a>
							...
							<TableRow>
								<TableCell>
									<a href={`#endpint-post-${pathString}`}>
										<Badge
											className={`text-lg text-white font-bold ${getMethodBadgeColor("post")}`}
										>
											POST
										</Badge>
									</a>
							...
							<TableRow>
								<TableCell>
									<a href={`#endpint-delete-${pathString}`}>
										<Badge
											className={`text-lg text-white font-bold ${getMethodBadgeColor("delete")}`}
										>
											DELETE
										</Badge>
									</a>
							...
							<TableRow>
								<TableCell>
									<a href={`#endpint-put-${pathString}`}>
										<Badge
											className={`text-lg text-white font-bold ${getMethodBadgeColor("put")}`}
										>
											PUT
										</Badge>
									</a>
							...
							<TableRow>
								<TableCell>
									<a href={`#endpint-patch-${pathString}`}>
										<Badge
											className={`text-lg text-white font-bold ${getMethodBadgeColor("patch")}`}
										>
											PATCH
										</Badge>
									</a>
